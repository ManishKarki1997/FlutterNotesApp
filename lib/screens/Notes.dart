...
class _NotesState extends State<Notes> {
  ...
  return Scaffold(
    body: SafeArea(
      child: notesProvider.notes.length > 0 ? Container(
  ...
  staggeredTileBuilder: (int index) =>
        new StaggeredTile.count(2, (notesProvider.notes[index].title.toString().length <= 40) ? 1.2 :  (notesProvider.notes[index].title.toString().length > 40 && notesProvider.notes[index].title.toString().length <= 80 ) ? 2.4 :  4),
  mainAxisSpacing: 6.0,
